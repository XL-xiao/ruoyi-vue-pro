...
(
    20
) NOT NULL GENERATED BY DEFAULT AS IDENTITY COMMENT '编号',
    "category" varchar
(
    50
) NOT NULL,
...
(
    20
) NOT NULL GENERATED BY DEFAULT AS IDENTITY COMMENT '任务编号',
    "name" varchar
(
    32
...
(
    4
) NOT NULL COMMENT '任务状态',
    "handler_name" varchar
(
    64
) NOT NULL COMMENT '处理器的名字',
    "handler_param" varchar
(
    255
) DEFAULT NULL COMMENT '处理器的参数',
    "cron_expression" varchar
(
    32
) NOT NULL COMMENT 'CRON 表达式',
    "retry_count" int
(
    11
...
(
    11
) NOT NULL DEFAULT '0' COMMENT '重试间隔',
    "monitor_timeout" int
(
    11
) NOT NULL DEFAULT '0' COMMENT '监控超时时间',
    "creator" varchar
(
    64
) DEFAULT '' COMMENT '创建者',
...
(
    20
) NOT NULL GENERATED BY DEFAULT AS IDENTITY COMMENT '日志编号',
    "job_id" bigint
(
    20
) NOT NULL COMMENT '任务编号',
    "handler_name" varchar
(
    64
) NOT NULL COMMENT '处理器的名字',
...
(
    ...
    "execute_index" tinyint
(
    4
) NOT NULL DEFAULT '1' COMMENT '第几次执行',
    "begin_time" datetime NOT NULL COMMENT '开始执行时间',
    "end_time" datetime DEFAULT NULL COMMENT '结束执行时间',
    "duration" int
(
    11
) DEFAULT NULL COMMENT '执行时长',
    "status" tinyint
(
    4
) NOT NULL COMMENT '任务状态',
...
(
    1
) NOT NULL DEFAULT FALSE COMMENT '是否删除',
    PRIMARY KEY
(
    "id"
)
...
(
    ...
    "exception_class_name" varchar
(
    512
) not null,
    "exception_file_name" varchar
(
    512
) not null,
    "exception_method_name" varchar
(
    512
) not null,
